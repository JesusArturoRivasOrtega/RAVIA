...
android {
    namespace = "com.ravia.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.ravia"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
        ...
        // Maps API key placeholder — replace with your real key
    }

    buildTypes {
        debug {
            isDebuggable = true
            buildConfigField("String", "BASE_URL", debugApiBaseUrl.asBuildConfigString())
        }
        release {
